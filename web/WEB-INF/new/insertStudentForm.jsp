        	...
        	<div class='templatemo_post_section'>
            	...
            	<div class='post_content'>                	
                    <div id='contact_form2'>
						 ...
						 <label> Student Name: </label> <input type='text' id='student_name' name='student_name' class='required input_field' />
						<div class='cleaner_h10'></div>
						 <label> Batch: </label> <input type='text' id='batch' name='batch' class='required input_field' />
						<div class='cleaner_h10'></div>
						<label> Roll: </label> <input type='text' id='roll' name='roll' class='required input_field' />
						<div class='cleaner_h10'></div>
						<label> Registration Num: </label> <input type='text' id='roll' name='roll' class='required input_field' />
						<div class='cleaner_h10'></div>
