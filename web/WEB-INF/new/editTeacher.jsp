<%-- 
    ...
    Created on : Feb 24, 2015, 9:21:17 PM
    Author     : USER
--%>
            	...
            	<div class="post_content">                	
                    <div id="contact_form2">
					  <form method="post" action="#">
							...
							<label> Teacher Email: </label> <input type="text" id="teacher_name" name="teacher_name" class="required input_field" />
							<div class="cleaner_h10"></div>
							<label> New Email: </label> <input type="text" id="department" name="department" class="required input_field" />
							<div class="cleaner_h10"></div>
							<label> New Cell Number:</label> <input type="text" id="email" name="email" class="required input_field" />
							<div class="cleaner_h10"></div>
