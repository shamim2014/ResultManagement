<%-- 
    Document   : batchSemesterInfo
    Created on : Feb 24, 2015, 10:12:04 PM
    Author     : USER
--%>
...
<title>SemesterInformation</title>
            	...
            	<div class="post_content">                	
                    <div id="contact_form2">
					  <form method="post" action="#">
						 ...
						 <label>Batch: </label> <input type="text" id="student_name" name="student_name" class="required input_field" />
						<div class="cleaner_h10"></div>
						  <label>Session:</label>  <select id="course_year" name="course_year" class="select"/>
						 <option value="1st">2014-15</option>
						 <option value="2nd">2015-16</option>
						 </select>
						 <div class="cleaner_h10"></div>
						...
						<div class="cleaner_h10"></div>
						 <label>Semester:</label>  <select id="course_year" name="course_year" class="select"/>
						 <option value="1st">1st</option>
						 <option value="2nd">2nd</option>
						 </select>
						 <div class="cleaner_h10"></div>
