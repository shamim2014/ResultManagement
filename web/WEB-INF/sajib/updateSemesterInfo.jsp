<%-- 
    Document   : updateSemesterInfo
    Created on : Feb 24, 2015, 10:15:28 PM
    Author     : USER
--%>
                    ...
                    <div id="contact_form2">
					  <form method="post" action="#">
						...
						<div class="cleaner_h10"></div>
						 ...
						 <div class="cleaner_h10"></div>
						<input name="submit" type="submit" class="submit_btn" value="Update" style="margin-left:360px;" />
						</form>
					</div>                   
                </div>
            </div> <!-- end of 1 post -->
