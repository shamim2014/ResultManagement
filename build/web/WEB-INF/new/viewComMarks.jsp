<%-- 
    Document   : viewComMarks
    Created on : Feb 24, 2015, 10:16:57 PM
    Author     : USER
--%>
...
<div id="templatemo_menu_panel">
    <div id="templatemo_menu_section">
        <ul class="dropdown">
		    <li><a href="home.html">Incourse/Lab Marks</a></li> 
			<li><a href="home.html">Semester Final Marks</a></li> 
			 <li><a href="#">Generate Final Result</a>
