<%-- 
    Document   : editCourseTeacher
    Created on : Feb 24, 2015, 9:40:08 PM
    Author     : USER
--%>
            	...
            	<div class="post_content">                	
                    <div id="contact_form2">
					  <form method="post" action="#">
						 ...
						 <label> Course Name: </label> <input type="text" id="student_name" name="student_name" class="required input_field" />
						<div class="cleaner_h10"></div>
						 <label> Course ID: </label> <input type="text" id="batch" name="batch" class="required input_field" />
						<div class="cleaner_h10"></div>
						 <label>Session:</label>  <input type='text' id='project_marks' name='project_marks' placeholder='Example(2014-15)' class='required input_field' /><br/>
						 <div class="cleaner_h10"></div>
						 <label>Teacher Email: </label> <input type="text" id="roll" name="roll" class="required input_field" />
						<div class="cleaner_h10"></div>
						<input name="submit" type="submit" class="submit_btn" value="Insert" style="margin-left:370px;" />
						</form>
					</div>                   
                </div>
            </div> <!-- end of 1 post -->
