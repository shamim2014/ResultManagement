...
<%
      ...
      String view ="<form method='post' action='CourseSemesterForm?pagename=Insert'>";
        view +="<label> Course Code: </label><select id='course_code' name='course_code' class='select' >";
            
        for(Course course : courses)
        {
            view +="<option value='"+course.getCourseCode()+"'>"+course.getCourseCode()+"</option>";
        }
