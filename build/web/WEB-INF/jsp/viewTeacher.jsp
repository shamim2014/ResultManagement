         ...
         <div id='templatemo_content_right'>
           ...
           <% 
                ...
                else if(incourseMarkDistributuion!=null && incourses!=null)
                {
                 ...
                 else if(batchSemesters!=null)
                 { 
                        finalView +="<table><tr><th>BATCH</th><th>YEAR</th><th>SEMESTER</th><th>SESSION</th></tr>";
                        for(BatchSemester batchSemester:batchSemesters)
                        {
                            finalView +="<tr><td>"+batchSemester.getBatch()+"</td><td>"+batchSemester.getYear()+"</td><td>"+batchSemester.getSemester()+"</td><td>"+batchSemester.getSession()+"</td></tr>";                    
                        }
                        finalView +="</table>";
                 }
